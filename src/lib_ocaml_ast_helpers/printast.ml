...
let fmt_position with_name f l =
  ...
  else fprintf f "%s[%d,%d+%d]" fname l.pos_lnum l.pos_bol (l.pos_cnum - l.pos_bol)
...
let rec core_type i ppf x =
  ...
  | Ptyp_arrow (l, ct1, ct2) ->
    ...
    core_type i ppf ct1;
    core_type i ppf ct2
  | Ptyp_tuple l -> line i ppf "Ptyp_tuple\n"; list i core_type ppf l
  | Ptyp_constr (li, l) ->
...
and pattern i ppf x =
  ...
  | Ppat_tuple l -> line i ppf "Ppat_tuple\n"; list i pattern ppf l
  | Ppat_construct (li, po) ->
    line i ppf "Ppat_construct %a\n" fmt_longident_loc li;
    option i
      (fun i ppf (vl, p) -> list i string_loc ppf vl; pattern i ppf p)
      ppf po
  | Ppat_variant (l, po) ->
  ...
  | Ppat_or (p1, p2) -> line i ppf "Ppat_or\n"; pattern i ppf p1; pattern i ppf p2
  | Ppat_lazy p -> line i ppf "Ppat_lazy\n"; pattern i ppf p
  | Ppat_constraint (p, ct) ->
    line i ppf "Ppat_constraint\n";
    pattern i ppf p;
    core_type i ppf ct
  | Ppat_type li -> line i ppf "Ppat_type\n"; longident_loc i ppf li
...
and expression i ppf x =
  ...
  | Pexp_match (e, l) ->
    line i ppf "Pexp_match\n"; expression i ppf e; list i case ppf l
  | Pexp_try (e, l) ->
    line i ppf "Pexp_try\n"; expression i ppf e; list i case ppf l
  | Pexp_tuple l -> line i ppf "Pexp_tuple\n"; list i expression ppf l
  ...
  | Pexp_record (l, eo) ->
    ...
    option i expression ppf eo
  | Pexp_field (e, li) ->
    line i ppf "Pexp_field\n"; expression i ppf e; longident_loc i ppf li
  | Pexp_setfield (e1, li, e2) ->
    line i ppf "Pexp_setfield\n";
    expression i ppf e1;
    longident_loc i ppf li;
    expression i ppf e2
  | Pexp_array l -> line i ppf "Pexp_array\n"; list i expression ppf l
  ...
  | Pexp_sequence (e1, e2) ->
    ...
    expression i ppf e2
  | Pexp_while (e1, e2) ->
    line i ppf "Pexp_while\n"; expression i ppf e1; expression i ppf e2
  ...
  | Pexp_letexception (cd, e) ->
    ...
    expression i ppf e
  | Pexp_assert e -> line i ppf "Pexp_assert\n"; expression i ppf e
  | Pexp_lazy e -> line i ppf "Pexp_lazy\n"; expression i ppf e
  | Pexp_poly (e, cto) ->
    line i ppf "Pexp_poly\n"; expression i ppf e; option i core_type ppf cto
  | Pexp_object s -> line i ppf "Pexp_object\n"; class_structure i ppf s
  | Pexp_newtype (s, e) ->
    line i ppf "Pexp_newtype \"%s\"\n" s.txt;
    expression i ppf e
  | Pexp_pack me -> line i ppf "Pexp_pack\n"; module_expr i ppf me
  | Pexp_open (o, e) ->
...
and class_type_field i ppf x =
  ...
  | Pctf_attribute a -> attribute i ppf "Pctf_attribute" a
...
and class_field i ppf x =
  ...
  | Pcf_attribute a -> attribute i ppf "Pcf_attribute" a
  | Pcf_extension (s, arg) ->
...
and class_field_kind i ppf = function
  | Cfk_concrete (o, e) ->
    ...
    expression i ppf e
  | Cfk_virtual t -> line i ppf "Virtual\n"; core_type i ppf t
...
and module_type i ppf x =
  ...
  | Pmty_typeof m -> line i ppf "Pmty_typeof\n"; module_expr i ppf m
...
and signature_item i ppf x =
  ...
  | Psig_value vd -> line i ppf "Psig_value\n"; value_description i ppf vd
  | Psig_type (rf, l) ->
  ...
  | Psig_typesubst l ->
    ...
    list i type_declaration ppf l
  | Psig_typext te -> line i ppf "Psig_typext\n"; type_extension i ppf te
  | Psig_exception te ->
  ...
  | Psig_extension ((s, arg), attrs) ->
    ...
    payload i ppf arg
  | Psig_attribute a -> attribute i ppf "Psig_attribute" a
...
and module_expr i ppf x =
  ...
  | Pmod_functor (Named (s, mt), me) ->
    ...
    module_expr i ppf me
  | Pmod_apply (me1, me2) ->
    line i ppf "Pmod_apply\n"; module_expr i ppf me1; module_expr i ppf me2
  (* | Pmod_apply_unit me1 -> *)
  ...
  | Pmod_constraint (me, mt) ->
    ...
    module_expr i ppf me;
    module_type i ppf mt
  | Pmod_unpack e -> line i ppf "Pmod_unpack\n"; expression i ppf e
...
and structure_item i ppf x =
  ...
  | Pstr_eval (e, attrs) ->
    line i ppf "Pstr_eval\n"; attributes i ppf attrs; expression i ppf e
  | Pstr_value (rf, l) ->
  ...
  | Pstr_type (rf, l) ->
    ...
    list i type_declaration ppf l
  | Pstr_typext te -> line i ppf "Pstr_typext\n"; type_extension i ppf te
  | Pstr_exception te ->
    line i ppf "Pstr_exception\n";
    type_exception i ppf te
  | Pstr_module x -> line i ppf "Pstr_module\n"; module_binding i ppf x
  ...
  | Pstr_extension ((s, arg), attrs) ->
    ...
    attributes i ppf attrs;
    payload i ppf arg
  | Pstr_attribute a -> attribute i ppf "Pstr_attribute" a
...
and constructor_decl
    i ppf { pcd_name; pcd_vars; pcd_args; pcd_res; pcd_loc; pcd_attributes }
  =
...
and binding_op i ppf x =
  line i ppf "<binding_op> %a %a" fmt_string_loc x.pbop_op fmt_location x.pbop_loc;
